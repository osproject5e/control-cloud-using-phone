...
public class Instances extends CLConnection {
	 ...
	 * 
	 * //ArrayList<String> instances ; private static void init() throws
	 * Exception { System.out.println("in function init"); AWSCredentials
	...
	public Set<Instance> getRunningInstances() throws Exception {
		...
		// output= output + "You have " + instances.size() +
		// " Amazon EC2 instance(s) running.";
